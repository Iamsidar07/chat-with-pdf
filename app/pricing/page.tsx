      ...
      <MaxWidthWrapper className="mb-8 mt-24 max-w-5xl text-center">
        <div className="mx-auto mb-10 sm:max-w-lg">
          ...
          <p className="mt-5 text-gray-600 sm:text-lg">
            Whether yo&apos;re just trying out our service or need more,
            we&apos;ve got you covered
          </p>
        </div>
        <div className="pt-12 grid grid-cols-1 gap-10 lg:grid-cols-2">
          <TooltipProvider>
            {pricingItems.map(({ quota, plan, tagline, features }) => {
              const price =
                ...
                >
                  ...
                  <div className="flex h-20 items-center justify-center border-b border-t border-gray-200 ">
                    <div className="flex items-center space-x-1">
                      <p>{price.toLocaleString()} PDFs/mo included</p>
                        ...
                        {footnote ? (
                          <div className="flex items-center space-x-1">
                            ...
                            <Tooltip delayDuration={300}>
                              <TooltipTrigger className="cursor-default ml-1.5">
                                <HelpCircle className="text-zinc-400 h-4 w-4" />
                              </TooltipTrigger>
                              <TooltipContent className="w-80 p-2">
                                {footnote}
                              </TooltipContent>
